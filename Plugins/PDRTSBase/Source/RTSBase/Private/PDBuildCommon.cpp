...
UE_DEFINE_GAMEPLAY_TAG(TAG_BUILD_ActionContext_Base0, "BUILD.ActionContext.Base0");
UE_DEFINE_GAMEPLAY_TAG(TAG_BUILD_ActionContext_Base1, "BUILD.ActionContext.Base1");
