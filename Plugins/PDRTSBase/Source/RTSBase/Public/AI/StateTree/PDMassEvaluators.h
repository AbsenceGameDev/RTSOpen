...
#include "PDMassEvaluators.generated.h"
...
/**
 * @brief Simplest of evaluators. Literally only returns data held by the entity manager so we can pass it along to some down-stream tasks 
 */
USTRUCT()
struct PDRTSBASE_API FPDMEvaluator_EntityAction : public FMassStateTreeEvaluatorBase
{
	GENERATED_BODY()
