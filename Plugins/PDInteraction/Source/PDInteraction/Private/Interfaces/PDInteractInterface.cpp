...
void IPDInteractInterface::OnInteract_Implementation(const FPDInteractionParamsWithCustomHandling& InteractionParams, EPDInteractResult& InteractResult) const
{
	InteractResult = EPDInteractResult::INTERACT_UNHANDLED;
	if (InteractionParams.CustomInteractionProcessor.IsBound() == false) { return; }

	InteractionParams.CustomInteractionProcessor.Execute(InteractionParams, InteractResult);
}
