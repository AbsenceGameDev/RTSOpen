...
| Description | <h6>Keep network load ligther when there are many recipients and senders</h6> | <h6>Message datums that contain a message tag, to be routed to a list of game messages to display to the target actor</h6> | <h6>Registers network managers to route RX/TX messages to managed actors</h6> |
